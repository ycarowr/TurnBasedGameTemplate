...
namespace TurnBasedGameTemplate.Tools.Extensions.Transform
{
    /// <summary> 
    ///     Extension methods for UnityEngine.Transform.Ref:
    ///     https://github.com/mminer/unity-extensions/blob/master/TransformExtensions.cs
    /// </summary>
    public static class TransformExtensions
    {
        /// <summary> Makes the given game objects children of the transform.</summary>
        ...
        /// <summary> Makes the game objects of given components children of the transform.</summary>
        /// <param name="transform">Parent transform.</param>
        ...
        /// <summary> Sets the position of a transform's children to zero.</summary>
        /// <param name="transform">Parent transform.</param>
        ...
        /// <summary> Sets the layer of the transform's children.</summary>
        /// <param name="transform">Parent transform.</param>
        ...
        /// <summary> Sets the x component of the transform's position.</summary>
        ...
        /// <summary> Sets the y component of the transform's position.</summary>
        ...
        /// <summary> Sets the z component of the transform's position.</summary>
